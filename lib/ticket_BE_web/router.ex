defmodule Ticket_BEWeb.Router do
  ...
  # error_routes = [
  #   {Ticket_BEWeb.ErrorJSON, [only: [:json]]}
  # ]

  # resources "/*path", Ticket_BEWeb.ErrorController
  # get "/*path", Ticket_BEWeb.ErrorController, :not_found
